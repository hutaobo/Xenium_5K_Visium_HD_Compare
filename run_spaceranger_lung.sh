...
SRC=/mnt/taobo.hu/long/10X_datasets/Visium/Visium_HD/Visium_HD_Human_Lung_Cancer_post_Xenium_Prime_5K_Experiment2
SAMPLE=Visium_HD_Human_Lung_Cancer_post_Xenium_Prime_5K_Experiment2

OUT=/data/taobo.hu/5K_HD              # writable output root directory
ID=lung_prime5k_sr4_cell              # Space Ranger --id
REF=$HOME/ref/refdata-gex-GRCh38-2024-A   # reference genome directory
